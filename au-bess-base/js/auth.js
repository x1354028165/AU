...
const TRANSLATIONS = {
  en: {
    ...
    confirm_stop_desc: 'Are you sure you want to stop the current operation? The station will return to idle state.',
    ...
    // AI Decision Panel
    ai_panel_title: 'AI Decision Engine',
    ai_thinking: 'AI Thinking',
    ai_status_analyzing: 'Analyzing market data and price trends…',
    ai_status_price_drop: 'Detected price downtrend — evaluating charge opportunity…',
    ai_status_price_rise: 'Price uptrend detected — preparing discharge strategy…',
    ai_status_spike_watch: 'Monitoring potential price spike — ready to respond…',
    ai_status_optimizing: 'Optimizing charge/discharge schedule for max profit…',
    ai_status_executing: 'Executing planned operation…',
    ai_status_fcas: 'FCAS standby — earning ancillary service revenue…',
    ai_decision_logic: 'Decision Logic',
    ai_logic_price_trend: 'Price Trend',
    ai_logic_trend_rising: 'Rising',
    ai_logic_trend_falling: 'Falling',
    ai_logic_trend_stable: 'Stable',
    ai_logic_trend_spike: 'Spike Alert',
    ai_logic_soc_state: 'SoC Status',
    ai_logic_soc_low: 'Low — priority charge',
    ai_logic_soc_high: 'High — ready to discharge',
    ai_logic_soc_mid: 'Moderate — standby',
    ai_logic_forecast: 'Price Forecast',
    ai_logic_forecast_up: 'Forecast rising — hold energy',
    ai_logic_forecast_down: 'Forecast dropping — charge now',
    ai_logic_forecast_stable: 'Forecast stable — follow plan',
    ai_logic_spread: 'Arbitrage Spread',
    ai_decision_result: 'Decision Result',
    
    // AI 动态翻译
    ai_logic_trend_rising: 'Price Rising',
    ai_logic_trend_falling: 'Price Falling', 
    ai_logic_trend_spike: 'Price Spike',
    ai_logic_trend_stable: 'Stable',
    ai_logic_forecast_up: 'Upward',
    ai_logic_forecast_down: 'Downward',
    ai_logic_soc_low: 'Low SoC',
    ai_logic_soc_high: 'High SoC',
    ai_logic_soc_optimal: 'Optimal',
    ai_action_charge: 'CHARGE',
    ai_action_discharge: 'DISCHARGE',
    ai_action_hold: 'HOLD',
    ai_action_fcas: 'FCAS',
    ai_confidence_high: 'High',
    ai_confidence_medium: 'Medium',
    ai_confidence_low: 'Low',
    ai_planned_action: 'Planned Action',
    ai_execute_time: 'Execute At',
    ai_target_soc: 'Target SoC',
    ai_power_level: 'Power Level',
    ai_expected_profit: 'Expected Profit',
    ai_profit_this_cycle: 'This Cycle Profit',
    ai_profit_today: 'Today Cumulative',
    ai_profit_spread: 'Avg Spread',
    ai_confidence: 'Confidence',
    ai_last_updated: 'Last Updated',
    ai_next_update: 'Next Update In',
    ai_seconds: 's',

    // Reports
    menu_reports: 'Reports',
    reports_title: 'Arbitrage Reports',
    reports_station_select: 'Select Station',
    reports_period: 'Period',
    reports_daily: 'Daily',
    reports_monthly: 'Monthly',
    reports_yearly: 'Yearly', 
    reports_cumulative: 'Cumulative',
    reports_arbitrage_summary: 'Arbitrage Summary',
    reports_total_profit: 'Total Profit',
    reports_total_cycles: 'Total Cycles',
    reports_avg_spread: 'Avg Spread',
    reports_efficiency: 'Efficiency',
    reports_trend_chart: 'Profit Trend',
    reports_charge_cost: 'Charge Cost',
    reports_discharge_revenue: 'Discharge Revenue',
    reports_net_profit: 'Net Profit',
    reports_export_excel: 'Export Excel',
    reports_export_pdf: 'Export PDF',
    reports_charge_energy: 'Charge Energy',
    reports_discharge_energy: 'Discharge Energy',
    reports_price_range: 'Price Range',
    reports_start_time: 'Start Time',
    reports_end_time: 'End Time',
    ...
    reports_chart_view: 'Chart View',
    reports_table_view: 'Table View',
    reports_refresh: 'Refresh',
    reports_vs_yesterday: 'vs Yesterday',
    reports_vs_last_month: 'vs Last Month', 
    reports_vs_last_year: 'vs Last Year',
    reports_charge_discharge: 'Charge & Discharge',
    reports_cumulative_profit: 'Cumulative Profit',
    reports_detail_title: 'Arbitrage Details',
    reports_avg_buy_price: 'Avg Buy Price',
    reports_avg_sell_price: 'Avg Sell Price',
    reports_total: 'Total',
  ...
  zh: {
    ...
    stop: '停止',
    confirm_stop: '确认停止',
    confirm_stop_desc: '确定要停止当前操作吗？电站将恢复为待机状态。',
    confirm_add: '创建电站',
    device_name: '设备名称',
    device_type: '设备类型',
    device_version: '版本号',
    ...
    // AI 决策面板
    ai_panel_title: 'AI 决策引擎',
    ai_thinking: 'AI 思考中',
    ai_status_analyzing: '正在分析市场数据和价格趋势…',
    ai_status_price_drop: '检测到价格下行趋势 — 评估充电机会…',
    ai_status_price_rise: '检测到价格上行趋势 — 准备放电策略…',
    ai_status_spike_watch: '监测到潜在价格尖峰 — 准备响应…',
    ai_status_optimizing: '优化充放电计划以最大化收益…',
    ai_status_executing: '正在执行计划操作…',
    ai_status_fcas: 'FCAS 待机中 — 赚取辅助服务收益…',
    ai_decision_logic: '决策逻辑',
    ai_logic_price_trend: '价格趋势',
    ai_logic_trend_rising: '上升中',
    ai_logic_trend_falling: '下降中',
    ai_logic_trend_stable: '平稳',
    ai_logic_trend_spike: '尖峰预警',
    ai_logic_soc_state: 'SoC 状态',
    ai_logic_soc_low: '电量低 — 优先充电',
    ai_logic_soc_high: '电量高 — 可以放电',
    ai_logic_soc_mid: '电量适中 — 待机观望',
    ai_logic_forecast: '价格预测',
    ai_logic_forecast_up: '预测上涨 — 保持储能',
    ai_logic_forecast_down: '预测下跌 — 立即充电',
    ai_logic_forecast_stable: '预测平稳 — 按计划执行',
    ai_logic_spread: '套利价差',
    ai_decision_result: '决策结果',
    
    // AI 动态翻译
    ai_logic_trend_rising: '价格上涨',
    ai_logic_trend_falling: '价格下跌',
    ai_logic_trend_spike: '价格尖峰',
    ai_logic_trend_stable: '稳定',
    ai_logic_forecast_up: '上涨趋势',
    ai_logic_forecast_down: '下跌趋势',
    ai_logic_soc_low: '低电量',
    ai_logic_soc_high: '高电量',
    ai_logic_soc_optimal: '最优电量',
    ai_action_charge: '充电',
    ai_action_discharge: '放电',
    ai_action_hold: '待机',
    ai_action_fcas: 'FCAS',
    ai_confidence_high: '高',
    ai_confidence_medium: '中',
    ai_confidence_low: '低',
    ai_planned_action: '计划操作',
    ai_execute_time: '执行时间',
    ai_target_soc: '目标 SoC',
    ai_power_level: '功率级别',
    ai_expected_profit: '预期收益',
    ai_profit_this_cycle: '本次周期收益',
    ai_profit_today: '今日累计',
    ai_profit_spread: '平均价差',
    ai_confidence: '置信度',
    ai_last_updated: '上次更新',
    ai_next_update: '下次更新',
    ai_seconds: '秒',
    ...
    menu_reports: '报告中心',
    reports_title: '套利报告',
    reports_station_select: '选择电站',
    reports_period: '时间周期',
    reports_daily: '日报',
    reports_monthly: '月报',
    reports_yearly: '年报',
    reports_cumulative: '累计报告',
    reports_arbitrage_summary: '套利汇总',
    reports_total_profit: '总利润',
    reports_total_cycles: '套利次数',
    reports_avg_spread: '平均价差',
    reports_efficiency: '运行效率',
    reports_trend_chart: '收益趋势',
    reports_charge_cost: '充电成本',
    reports_discharge_revenue: '放电收入',
    reports_net_profit: '净利润',
    reports_export_excel: '导出Excel',
    reports_export_pdf: '导出PDF',
    reports_charge_energy: '充电电量',
    reports_discharge_energy: '放电电量',
    reports_price_range: '价格区间',
    reports_start_time: '开始时间',
    reports_end_time: '结束时间',
    reports_duration: '持续时长',
    reports_date: '日期',
    ...
    reports_chart_view: '图表视图',
    reports_table_view: '表格视图',
    reports_refresh: '刷新',
    reports_vs_yesterday: '比昨日',
    reports_vs_last_month: '比上月',
    reports_vs_last_year: '比去年', 
    reports_charge_discharge: '充放电量',
    reports_cumulative_profit: '累计净利润',
    reports_detail_title: '套利明细',
    reports_avg_buy_price: '充电均价',
    reports_avg_sell_price: '放电均价',
    reports_total: '合计',
    export_success: '导出成功',
