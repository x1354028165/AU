...
const TRANSLATIONS = {
  en: {
    ...
    btn_resume_ai: 'Resume Smart Hosting',
    dispatch_mode_smart: 'Smart Hosting',
    dispatch_mode_manual: 'Manual Override',
    next_action: 'Next Action',
    expect_discharge_at: 'Expect discharge at {0}:00',
    expect_charge_at: 'Expect charge at {0}:00',
    projected_profit: 'Est. Profit',
    fcas_standby: 'FCAS standby — earning A${0}',
    ai_target: 'Target: Seize {0}:00 Peak | Plan: Multi-stage discharge | Est. Profit: A${1}',
  ...
  zh: {
    ...
    btn_resume_ai: '恢复智能托管',
    dispatch_mode_smart: '智能托管',
    dispatch_mode_manual: '手动接管',
    next_action: '下一动作',
    expect_discharge_at: '预计 {0}:00 放电',
    expect_charge_at: '预计 {0}:00 充电',
    projected_profit: '预计收益',
    fcas_standby: 'FCAS 待机中 — 已获 A${0}',
    ai_target: '目标：捕捉 {0}:00 尖峰 | 计划：分段放电 | 预计收益：A${1}',
    power_output: '输出功率',
