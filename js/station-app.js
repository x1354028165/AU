        ...
        function renderTableView() {
            ...
            tbody.innerHTML = pageData.map(station => `
                <tr>
                    ...
                    <td>
                        <button class="table-action-btn" style="background: rgba(0, 255, 136, 0.1); border-color: rgba(0, 255, 136, 0.3); color: #00ff88;" onclick="viewStation('${station.id}')" data-i18n="station.detail">详情</button>
            ...
            grid.innerHTML = pageData.map(station => `
                <div class="station-card" onclick="viewStation('${station.id}')">
                    ...
                    <div class="station-card-body">
                        ...
                        <div class="station-stat">
                            <div class="station-stat-label">累计净利润</div>
                    ...
                    <div class="station-card-footer">
                        ...
                        <div class="station-actions">
                            <button class="station-action-btn" onclick="event.stopPropagation(); controlStation('${station.id}')">详情</button>
                        </div>
                    </div>
                </div>
            `).join('');
